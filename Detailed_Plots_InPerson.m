...
scatter([1:8,1:8]',[ones(1,8) 2*ones(1,8)]',3000,Scaled_Education_ReceiveAQN(:),'filled')
colormap jet; colorbar; box on
axis([0.5 8.5 0.5 2.5])
set(gca,'xticklabel',{['8th grade or less (',num2str(Size_Education(1)),')'], ['Some highschool, no diploma (',num2str(Size_Education(2)),')'], ['Highschool graduate, diploma or GED (',num2str(Size_Education(3)),')'],['Some college, no degree (',num2str(Size_Education(4)),')'],['Associates degree (',num2str(Size_Education(5)),')'],['Bachelor''s degree (',num2str(Size_Education(6)),')'],['Master''s degree (',num2str(Size_Education(7)),')'],['PhD, MD, JD, or similar (',num2str(Size_Education(8)),')']},'fontsize',26,'fontweight','bold')
xtickangle(30);
set(gca,'ytick',1:2,'yticklabel',{'Yes','No'})
...
scatter([1:8,1:8]',[ones(1,8) 2*ones(1,8)]',3000,Scaled_Education_SeekAQN(:),'filled')
colormap jet; colorbar; box on
axis([0.5 8.5 0.5 2.5])
set(gca,'xticklabel',{['8th grade or less (',num2str(Size_Education(1)),')'], ['Some highschool, no diploma (',num2str(Size_Education(2)),')'], ['Highschool graduate, diploma or GED (',num2str(Size_Education(3)),')'],['Some college, no degree (',num2str(Size_Education(4)),')'],['Associates degree (',num2str(Size_Education(5)),')'],['Bachelor''s degree (',num2str(Size_Education(6)),')'],['Master''s degree (',num2str(Size_Education(7)),')'],['PhD, MD, JD, or similar (',num2str(Size_Education(8)),')']},'fontsize',26,'fontweight','bold')
xtickangle(30);
...
scatter(repmat(1:8,1,11)',[ones(1,8) 2*ones(1,8) 3*ones(1,8) 4*ones(1,8) 5*ones(1,8) 6*ones(1,8) 7*ones(1,8) 8*ones(1,8) 9*ones(1,8) 10*ones(1,8) 11*ones(1,8)]',1000,Scaled_Education_ReceiveAQN(:),'filled')
colormap jet; colorbar; box on
axis([0.5 8.5 0 12])
set(gca,'xticklabel',{['8th grade or less (',num2str(Size_Education(1)),')'], ['Some highschool, no diploma (',num2str(Size_Education(2)),')'], ['Highschool graduate (',num2str(Size_Education(3)),')'],['Some college, no degree (',num2str(Size_Education(4)),')'],['Associates degree (',num2str(Size_Education(5)),')'],['Bachelor''s degree (',num2str(Size_Education(6)),')'],['Master''s degree (',num2str(Size_Education(7)),')'],['PhD, MD, JD, or similar (',num2str(Size_Education(8)),')']},'fontsize',26,'fontweight','bold')
xtickangle(30);
set(gca,'ytick',1:11,'yticklabel',{'Social media','Television','Online news sources','Newspapers','Friends or family','Personal Observation','State agencies','Idaho smoke blog','Federal sources','Road signs','Other'})
ytickangle(30);
grid on
...
scatter(repmat(1:8,1,7)',[ones(1,8) 2*ones(1,8) 3*ones(1,8) 4*ones(1,8) 5*ones(1,8) 6*ones(1,8) 7*ones(1,8)]',1000,Scaled_Education_ReceiveAQN(:),'filled')
colormap jet; colorbar; box on
axis([0.5 8.5 0 8])
set(gca,'xtick',1:8,'xticklabel',{['8th grade or less (',num2str(Size_Education(1)),')'], ['Some highschool, no diploma (',num2str(Size_Education(2)),')'], ['Highschool graduate (',num2str(Size_Education(3)),')'],['Some college, no degree (',num2str(Size_Education(4)),')'],['Associates degree (',num2str(Size_Education(5)),')'],['Bachelor''s degree (',num2str(Size_Education(6)),')'],['Master''s degree (',num2str(Size_Education(7)),')'],['PhD, MD, JD, or similar (',num2str(Size_Education(8)),')']},'fontsize',26,'fontweight','bold')
xtickangle(30);
set(gca,'ytick',1:7,'yticklabel',{'Green-Good','Yellow-Moderate','Orange-Unhealthy for Sensitives','Red-Unhealthy','Purple-Very Unhealthy','Maroon-Hazardous','Not Familiar'})
ytickangle(30);
grid on
...
%% Race versus min AQI to eliminate outside activity Q4/Q17 % variable names are not important
clear Race_ReceiveAQN Size_Race
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:6
...
%% Education versus min AQI to eliminate outside activity Q4/Q17 % variable names are not important
clear Education_ReceiveAQN Size_Education
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:8
...
%% Income versus min AQI to eliminate outside activity Q4/Q17 % variable names are not important
clear ReceiveAQN Size
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:5
...
%% Education versus wildfire smoke being a hazard Q4/Q24 % variable names are not important
clear Education_ReceiveAQN Size_Education
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:8
...
scatter(repmat(1:8,1,3)',[ones(1,8) 2*ones(1,8) 3*ones(1,8)]',3000,Scaled_Education_ReceiveAQN(:),'filled')
colormap jet; colorbar; box on
...
%% Income versus wildfire smoke being a hazard Q4/Q24 % variable names are not important
clear ReceiveAQN Size
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:5
...
%% Education versus wildfire smoke comparison with other hazards Q4/Q25 % variable names are not important
clear Education_ReceiveAQN Size_Education
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:8
...
scatter(repmat(1:8,1,5)',[ones(1,8) 2*ones(1,8) 3*ones(1,8) 4*ones(1,8) 5*ones(1,8)]',2000,Scaled_Education_ReceiveAQN(:),'filled')
colormap jet; colorbar; box on
axis([0.5 8.5 0.5 5.5])
set(gca,'xtick',1:8,'xticklabel',{['8th grade or less (',num2str(Size_Education(1)),')'], ['Some highschool, no diploma (',num2str(Size_Education(2)),')'], ['Highschool graduate (',num2str(Size_Education(3)),')'],['Some college, no degree (',num2str(Size_Education(4)),')'],['Associates degree (',num2str(Size_Education(5)),')'],['Bachelor''s degree (',num2str(Size_Education(6)),')'],['Master''s degree (',num2str(Size_Education(7)),')'],['PhD, MD, JD, or similar (',num2str(Size_Education(8)),')']},'fontsize',26,'fontweight','bold')
xtickangle(30);
set(gca,'ytick',1:5,'yticklabel',{'Much less severe/important','Somewhat less severe/important','About as severe/important','Somewhat more severe/important','Much more severe/important'})
ytickangle(30);
...
%% Income versus wildfire smoke comparison with other hazards Q4/Q25 % variable names are not important
clear ReceiveAQN Size
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:5
...
%% Education versus willingness to evacuate home due to wildfire smoke Q4/Q26 % variable names are not important
clear Education_ReceiveAQN Size_Education
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:8
...
scatter(repmat(1:8,1,4)',[ones(1,8) 2*ones(1,8) 3*ones(1,8) 4*ones(1,8)]',3000,Scaled_Education_ReceiveAQN(:),'filled')
colormap jet; colorbar; box on
...
%% Income versus willingness to evacuate home due to wildfire smoke Q4/Q26 % variable names are not important
clear ReceiveAQN Size
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:5
...
%% Health status versus willingness to evacuate home Q8/Q24 % variable names are not important
clear ReceiveAQN Size
figure
set(gcf,'color','w','units','normalized','position',[.05 .05 .75 .85],'paperpositionmode','auto');
for i = 1:4
